...
- Develop complete Power BI dashboards with DAX measures
- Perform KPI analysis, trend analysis, forecasting
- Clean, format, and model datasets for reporting
